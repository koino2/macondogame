...
public class Player extends Object2D {
    ...
    public PlayerWeaponRecorder playerWeaponRecorder;
    ...
    public Player(float xPos, float yPos, float rotation){
        ...
        try {
            texture = ImageIO.read(new File("src/assets/textures/entities/robot1-blue.png"));
        } catch (IOException e) {
        ...
        playerWeaponRecorder = new PlayerWeaponRecorder();
        addScript(playerWeaponRecorder);
